...
class MusicPlaybackService : MediaSessionService() {
    ...
    override fun onCreate() {
        ...
        val dataSourceFactory = buildPlaybackDataSourceFactory(this, app, app.driveTokenProvider)
        ...
        // Makes the system notification/lock-screen art tappable to reopen the app.
